      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <div className="sticky top-0 bg-white z-10 border-b">
          <div className="flex items-center justify-between px-4 py-2">
            ...
            <img src={avatar} alt="avatar" className="w-8 h-8 md:w-10 md:h-10" />
          </div>
        </div>
          ...
          {!showResult ? (
            <div className="max-w-6xl mx-auto px-4 py-8 md:py-12">
              ...
              <div className="text-[#c4c7c5] mb-8">
                ...
                <p className="text-2xl md:text-4xl mt-2">How can ElitesGPT help you today?</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-neutral-200 rounded-lg p-4 relative min-h-[100px] cursor-pointer hover:bg-neutral-300 transition-colors">
                  <p className="text-sm md:text-base pr-6">Suggest beautiful places to go on vacation</p>
                  <FaQuestionCircle size={16} className="absolute bottom-4 right-4" />
                </div>
                <div className="bg-neutral-200 rounded-lg p-4 relative min-h-[100px] cursor-pointer hover:bg-neutral-300 transition-colors">
                  <p className="text-sm md:text-base pr-6">Need some inspiration for your project?</p>
                  <FaLightbulb size={16} className="absolute bottom-4 right-4" />
                </div>
                <div className="bg-neutral-200 rounded-lg p-4 relative min-h-[100px] cursor-pointer hover:bg-neutral-300 transition-colors">
                  <p className="text-sm md:text-base pr-6">Want to learn more about AI capabilities?</p>
            ...
            <div className="max-w-4xl mx-auto px-4 py-6">
              <div className="result-title flex items-center gap-3 mb-6">
                ...
                <p className="text-sm md:text-base font-medium">{recentPrompt}</p>
              </div>
              <div className="flex items-start gap-3">
                ...
                {loading ? (
                  ...
                  <div className="ai-response text-sm md:text-base flex-1" 
